              ...
              <div className="flex w-full justify-center mb-6">
                <div className="inline-flex p-1 rounded-lg bg-muted">
                  <Button
                    ...
                    className={`rounded-md flex items-center gap-2 transition-all duration-300 ${mode === 'pomodoro' ? 'text-white' : 'text-muted-foreground hover:text-foreground'
                      }`}
                  ...
                  <Button
                    ...
                    className={`rounded-md flex items-center gap-2 transition-all duration-300 ${mode === 'shortBreak' ? 'text-white' : 'text-muted-foreground hover:text-foreground'
                      }`}
                  ...
                  <Button
                    ...
                    className={`rounded-md flex items-center gap-2 transition-all duration-300 ${mode === 'longBreak' ? 'text-white' : 'text-muted-foreground hover:text-foreground'
                      }`}
